<%@ page language="java" contentType="text/html; charset=UTF-8" 
    ...
    <head>
        <meta charset="UTF-8">
        <title>JobSeeker Add Resume</title>
                    ...
                    <div class="my-5 text-xl-start ">
                        <div class="card shadow " style="border-radius: 25px;background-color:#ece9e9;">
                            <div class="card-body p-4 " style="">
                                <h1 class=" card-title text-center pb-4 h3 "><span style="color:#000000;font-weight: bold; ">JobSeeker Add Resume</span> </h1>
                                <span class="card-text ">
                                <form action="resume" method="post" id="formsubmit">
                                    <span id="formerror "></span>
                                <div class="form-group mt-3">
                                    <label for="stream"><span class="font-weight-bold ">Stream:</span></label>
                                    <input required type="text" class="form-control " name="stream" id="stream" placeholder="Your Stream " value="">
                                </div>
                                <div class="form-group mt-3">
                                    <label for="college"><span class="font-weight-bold ">College:</span></label>
                                    <input required type="text" class="form-control " name="college" id="college" placeholder="Your College " value="">
                                </div>
                                <div class="form-group mt-3">
                                    <label for="experience"><span class="font-weight-bold ">Experience:</span></label>
                                    <input required type="number" class="form-control " name="experience" id="experience" placeholder="Your experience " min="0" max="30" value="">
                                </div>
                                <div class="form-group mt-3">
                                    <label for="languageknown"><span class="font-weight-bold ">Languages known:</span></label>
                                    <input required type="text" class="form-control " name="languageknown" id="languageknown" placeholder="Your Email Address " value="">
                                </div>
                                <div class="form-group mt-3">
                                    <label for="cgpa"><span class="font-weight-bold">Cgpa:</span></label>
                                    <input required type="number" class="form-control" name="cgpa" id="cgpa" placeholder="Your cgpa" value="" min="0" max="100">
                                </div>
                                <div class="form-group mt-3">
                                    <label for="projects"><span class="font-weight-bold ">Projects:</span></label>
                                    <input required type="text" class="form-control" name="projects" id="projects" placeholder="Your projects" value="">
                                </div>
                                <div class="form-group mt-3">
                                    <label for="yop"><span class="font-weight-bold ">YOP:</span></label>
                                    <input required type="number" class="form-control" name="yop" id="yop" placeholder="Your yop" value="" min="2015" >
                                </div>
                                <div class="form-group mt-3">
                                    <label for="skills"><span class="font-weight-bold ">Skills:</span></label>
                                    <input required type="text" class="form-control" name="skills" id="skills" placeholder="Your skills" value="">
                                </div>
                                <center><button type="submit" class="btn btn-dark mt-4 font-weight-bold">Add Resume</button></center>
                                </form>
