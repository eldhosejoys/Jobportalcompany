                    ...
                    <div class="my-5 text-xl-start ">
                        <div class="card shadow " style="border-radius: 25px;background-color:#ece9e9;">
                            <div class="card-body p-4 " style="">
                                <h1 class=" card-title text-center pb-4 h3 "><span style="color:#000000;font-weight: bold; ">JobProvider Profile</span> </h1>
                                ...
                                <div class="form-group ">
                                    ...
                                    <input required type="text " class="form-control " name="name" id="name"  value="<%=jp.getName() %>" placeholder="Your Comapany Name " readonly>
                                </div>
                                <div class="form-group mt-3">
                                    <label for="location"><span class="font-weight-bold ">Location:</span></label>
                                    <input required type="text" class="form-control " name="location" id="location" placeholder="Your Company Location" value="<%=jp.getLocation() %>" readonly>
                                </div>
                                <div class="form-group mt-3">
                                    <label for="contact"><span class="font-weight-bold ">Contact Number:</span></label>
                                    <input required type="number" class="form-control " name="contact" id="contact" placeholder="Your Company Contact Number" value="<%=jp.getContact() %>" readonly>
                                </div>
                                <div class="form-group mt-3">
                                    <label for="website"><span class="font-weight-bold ">Website:</span></label>
                                    <input required type="text" class="form-control " name="website" id="website" placeholder="Your Company Website" value="<%=jp.getWebsite() %>" readonly>
                                </div>
                                <div class="form-group mt-3">
                                    <label for="technology"><span class="font-weight-bold ">Technology:</span></label>
                                    <input required type="text" class="form-control " name="technology" id="technology" placeholder="Your Company Technology" value="<%=jp.getTechnology() %>" readonly>
                                </div>
                                <div class="form-group mt-3">
                                    <label for="email"><span class="font-weight-bold ">Email ID:</span></label>
                                    <input required type="email" class="form-control " name="email" id="email" placeholder="Your Email Address " value="<%=jp.getEmail() %>" readonly>
                                </div>
                                </form>
                                <div class="mt-3 text-center"><a href="editprovider.jsp">Edit JobProvider</a> 👉</div>
                                </span><br>
                            </div>
                        </div>
                    </div>
