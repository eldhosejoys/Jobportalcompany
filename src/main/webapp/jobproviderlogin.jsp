                    ...
                    <div class="my-5 text-xl-start ">
                        <div class="card shadow " style="border-radius: 25px;background-color:#ece9e9;">
                            <div class="card-body p-5 " style="">
                                <h1 class=" card-title text-center pb-4 h3 "><span style="color:#000000;font-weight: bold; ">JobProvider Login</span> </h1>
                                <span class="text-danger text-center"><%=message %></span>
                                <span class="card-text ">
                                <form action="jplogin" method="post" id="formsubmit">
                                ...
                                <div class="mt-3 text-center"><a href="jobproviderregister.jsp">Register for an account</a> 👉</div>
                                </span><br>
                            </div>
                        </div>
                    </div>
