            ...
            <div class="row gx-5 align-items-center justify-content-center">
                <div class="col-lg-8 col-xl-7 col-xxl-6">
                    <div class="my-5 text-center text-xl-start">
                        <h1 class="display-5 fw-bolder text-white mb-2 h6">JobProvider Home</h1>
                        <span class="text-dark"><%=message %></span>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                        </div>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start mt-3">
                            <a class="btn btn-light btn-lg px-4 rounded-pill" href="viewjobproviderprofile.jsp"><b>View Profile</b></a>
                            <a class="btn btn-light btn-lg px-4 rounded-pill" href="addjob.jsp"><b>Add Jobs</b></a>
                            <a class="btn btn-light btn-lg px-4 rounded-pill" href="viewjobs.jsp"><b>View Jobs</b></a></div>
                    </div>
                </div>
